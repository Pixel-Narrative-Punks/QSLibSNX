...
JNIEXPORT jobject JNICALL Java_com_libsnxqs_jni_QSLibSNX_getVarNameByIndex(JNIEnv *env, jobject this)
{
	//!!!STUB
//{
...
JNIEXPORT void JNICALL Java_com_libsnxqs_jni_QSLibSNX_init(JNIEnv *env, jobject this)
{
	...
	qspSetCallBack(QSP_CALL_OPENGAME, (*env)->GetMethodID(env, snxApiClass, "onOpenGame", "(Ljava/lang/String;Z)V"));
